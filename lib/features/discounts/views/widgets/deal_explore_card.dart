...
/// Deal card used on the explore screen.
///
/// Displays a [DealModel] with its photo, a save/discount badge (top-left),
/// a brand tag badge (bottom-right), then the title, subtitle and price row.
class DealExploreCard extends StatelessWidget {
  final DealModel deal;
  final VoidCallback? onTap;

  const DealExploreCard({super.key, required this.deal, this.onTap});
